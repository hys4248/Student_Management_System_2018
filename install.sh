...
wget --no-check-certificate https://github.com/yompc/Student_Management_System_2018/raw/master/src/liblkl-hijack.so
...
iptables -t nat -A PREROUTING -i eth0 -p tcp --dport 9000:9999 -j DNAT --to-destination 10.0.0.2
